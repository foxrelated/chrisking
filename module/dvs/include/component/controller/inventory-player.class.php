...
//				'modernizr.js' => 'module_dvs',
            ...
            ->assign(array(
                ...
                'sJavascript' => '<script type="text/javascript">var sBrowser = "' . $sBrowser . '"</script>'
                    ...
                    . (($aPlayer['player_type'] =="2") ? '' : '<script type="text/javascript" src="https://sadmin.brightcove.com/js/BrightcoveExperiences' . ($sBrowser == 'mobile' || $sBrowser == 'ipad' ? '' : '_all') . '.js"></script>')
