...
//			'playlist_border' => $oParseInput->clean($aVals['playlist_border'], 6),
			...
			'custom_overlay_1_url' => $oParseInput->clean($aVals['custom_overlay_1_url'], 255),
                        'custom_overlay_1_salesname' => $oParseInput->clean($aVals['custom_overlay_1_salesname'], 255),
                        'custom_overlay_1_dealername' => $oParseInput->clean($aVals['custom_overlay_1_dealername'], 255),
			...
			'custom_overlay_2_url' => $oParseInput->clean($aVals['custom_overlay_2_url'], 255),
                        'custom_overlay_2_salesname' => $oParseInput->clean($aVals['custom_overlay_2_salesname'], 255),
                        'custom_overlay_2_dealername' => $oParseInput->clean($aVals['custom_overlay_2_dealername'], 255),
			...
			'custom_overlay_3_url' => $oParseInput->clean($aVals['custom_overlay_3_url'], 255),
                        'custom_overlay_3_salesname' => $oParseInput->clean($aVals['custom_overlay_3_salesname'], 255),
                        'custom_overlay_3_dealername' => $oParseInput->clean($aVals['custom_overlay_3_dealername'], 255),
