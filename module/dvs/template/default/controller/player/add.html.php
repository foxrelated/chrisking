...
<script type="text/javascript">
	...
	<form method="post" action="{if $bIsDvs}{url link='dvs.player.add'}{else}{url link='idrive.add'}{/if}" onsubmit="return validateDvsForm();"  id="add_player" name="add_player">
		...
		<h4>{phrase var='dvs.player_controls'}</h4>
		...
		<h4>{phrase var='dvs.thumbnail_playlist'}</h4>
		...
		<div id="custom_overlay_input_container">
			...
			<h4>{phrase var='dvs.custom_overlay_1'}:</h4>
			
			<label for="custom_overlay_1_disabled">Disabled:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_1_extras').hide('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_1_type) && $aForms.custom_overlay_1_type == 0 || $bIsEdit && !isset($aForms.custom_overlay_1_type) || !isset($bEdit) || !$bEdit}checked="checked"{/if} value="0" name="val[custom_overlay_1_type]" id="custom_overlay_1_disabled" /><br />
			
			<label for="custom_overlay_1_price_overlay">Get Price Overlay:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_1_extras').hide('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_1_type) && $aForms.custom_overlay_1_type == 1}checked="checked"{/if} value="1" name="val[custom_overlay_1_type]" id="custom_overlay_1_price_overlay" /><br />
			
			<label for="custom_overlay_1_link_overlay">Link Overlay:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_1_extras').show('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_1_type) && $aForms.custom_overlay_1_type == 2}checked="checked"{/if} value="2" name="val[custom_overlay_1_type]" id="custom_overlay_1_link_overlay" /><br />
			...
			<h4>{phrase var='dvs.custom_overlay_2'}:</h4>
						
			<label for="custom_overlay_2_disabled">Disabled:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_2_extras').hide('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_2_type) && $aForms.custom_overlay_2_type == 0 || $bIsEdit && !isset($aForms.custom_overlay_2_type) || !isset($bEdit) || !$bEdit}checked="checked"{/if} value="0" name="val[custom_overlay_2_type]" id="custom_overlay_2_disabled" /><br />
							
			<label for="custom_overlay_2_price_overlay">Get Price Overlay:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_2_extras').hide('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_2_type) && $aForms.custom_overlay_2_type == 1}checked="checked"{/if} value="1" name="val[custom_overlay_2_type]" id="custom_overlay_2_price_overlay" /><br />
							
			<label for="custom_overlay_2_link_overlay">Link Overlay:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_2_extras').show('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_2_type) && $aForms.custom_overlay_2_type == 2}checked="checked"{/if} value="2" name="val[custom_overlay_2_type]" id="custom_overlay_2_link_overlay" /><br />
			...
			<h4>{phrase var='dvs.custom_overlay_3'}:</h4>
			
			<label for="custom_overlay_3_disabled">Disabled:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_3_extras').hide('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_3_type) && $aForms.custom_overlay_3_type == 0 || $bIsEdit && !isset($aForms.custom_overlay_3_type) || !isset($bEdit) || !$bEdit}checked="checked"{/if} value="0" name="val[custom_overlay_3_type]" id="custom_overlay_3_disabled" /><br />
			
			<label for="custom_overlay_3_price_overlay">Get Price Overlay:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_3_extras').hide('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_3_type) && $aForms.custom_overlay_3_type == 1}checked="checked"{/if} value="1" name="val[custom_overlay_3_type]" id="custom_overlay_3_price_overlay" /><br />
							
			<label for="custom_overlay_3_link_overlay">Link Overlay:</label> 
			<input type="radio" onchange="if ($(this).attr('checked') == 'checked')$('.custom_overlay_3_extras').show('fast');;" {if $bIsEdit && isset($aForms.custom_overlay_3_type) && $aForms.custom_overlay_3_type == 2}checked="checked"{/if} value="2" name="val[custom_overlay_3_type]" id="custom_overlay_3_link_overlay" /><br />
		...
		<input type="submit" value="{phrase var='dvs.save_settings'}" class="button" />
		{if $bIsDvs}
