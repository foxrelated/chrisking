...
<script type="text/javascript">
		$(document).ready(function() {left_curly}
			...
			{left_curly}
				if (!empty(this.value))
				{left_curly}
					$('#js_logo_file_form').ajaxCall('dvs.logoFileProcess');
				{right_curly}
			{right_curly});
		{right_curly});
</script>
<div id="js_logo_file_upload_container" style="background:#FFFFFF;">
	<div id="js_logo_file_content">
		...
		<form method="post" action="{url link='dvs.player.logo-file-frame'}" id="js_logo_file_form" enctype="multipart/form-data" target="js_logo_upload_frame">
