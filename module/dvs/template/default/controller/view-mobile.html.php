...
<!--		<div id="dvs_get_price_container" style="display:none;">
		...
		<div id="dvs_middle_container">
			...
			<div id="dvs_cta_button_container">
				...
				<a href="#" class="dvs_c2a_button" onclick="tb_show('{phrase var='dvs.contact_dealer'}', $.ajaxBox('dvs.showGetPriceForm', 'height=400&amp;width=360&amp;iDvsId={$iDvsId}&amp;sRefId=' + aCurrentVideoMetaData.referenceId)); menuContact('Call To Action Menu Clicks'); return false;">Get Best Price</a>
			</div>
