	...
	<section id="share_links">
		...
		<table>
			<tr>
				...
				<td>
                    <a href="#" onclick="window.open('https://www.facebook.com/dialog/feed?app_id=243763679155069&display=popup&caption=' + encodeURIComponent($('#share_title').val()) + '&link=' + encodeURIComponent($('#parent_ur').val().replace('WTVDVS_VIDEO_TEMP', $('#video_url').val())) + '&redirect_uri=' + encodeURIComponent($('#parent_ur').val().replace('WTVDVS_VIDEO_TEMP', $('#video_url').val())) + '&picture=' + encodeURIComponent($('#video_thumbnail').val()), '', 'width=626,height=436'); facebookShareClick('Share Links'); return false;">
