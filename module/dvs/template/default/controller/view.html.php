...
<article>
	...
	<div id="player_right">
		...
		<section id="action_links">
			...
			<a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u%20' + encodeURIComponent(location.href), 'facebook-share-dialog', 'width=626,height=436'); facebookShareClick(); $.ajaxCall('dvs.generateShortUrl', 'dvs_id={$aDvs.dvs_id}&video_ref_id=' + aCurrentVideoMetaData.referenceId + '&service=facebook&return_id=share_text_box_facebook_{$iKey}'); return false;">
