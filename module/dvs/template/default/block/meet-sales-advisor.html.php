...
<form id="contact_dealer" name="contact_dealer" action="javascript:void(0);">
    <div class="js_box_close closeContainer" aria-label="Close">
        ...
        <span class="js_box_history">dvs.showGetContactFormForMeetSalesAdvisor</span>
    </div>
    
    <div class="form-group col-2b no-padding getBestDealcol1">
        <div class="getBestDealDescription">
            <p>Please fill out the form and<br/>we will introduce you to our<br/>sales advisor who can help<br/>you find the ideal car for<br/>you.</p>
        </div>
    </div>   
    ...
    <div class="form-group col-2b no-padding getBestDealcol2">
        ...
        <div class="form-group">
            <input class="btn btn-primary submitButton" type="submit" value="Meet our top sales advisor"/>
        </div>
