    ...
    <table width="600" border="0" cellpadding="4" cellspacing="4" style="border:1px solid #cccccc;">
        ...
        <tr>
            ...
            <td valign="top" style="text-align:center;">
                <a href="{$sVideoLink}?utm_source=ShareLinks&amp;utm_medium=Email_Share&amp;utm_content={$aVideo.year}_{$aVideo.make}_{$aVideo.model}&amp;utm_campaign={$aDvs.dealer_name}" style="text-decoration:none;font-weight:bold;">Take your {$aVideo.year} {$aVideo.make} {$aVideo.model} Virtual Test Drive</a><br />
            </td>
        </tr>
        <tr>
            <td valign="top">
                {$sShareMessage}
                <br /><br />
                Take your <a href="{$sVideoLink}?utm_source=ShareLinks&amp;utm_medium=Email_Share&amp;utm_content={$aVideo.year}_{$aVideo.make}_{$aVideo.model}&amp;utm_campaign={$aDvs.dealer_name}" style="text-decoration:none;font-weight:bold;">{$aVideo.year} {$aVideo.make} {$aVideo.model} Virtual Test Drive</a> from {$aDvs.dealer_name} -- It's fun, easy, and free!
                <br /><br />
        ...
        <tr align="center">
            <td colspan="2" rowspan="1" valign="top">
                Sent from the <a href="{$sVideoLink}?utm_source=ShareLinks&amp;utm_medium=Email_Share&amp;utm_content={$aVideo.year}_{$aVideo.make}_{$aVideo.model}&amp;utm_campaign={$aDvs.dealer_name}">{$aDvs.dealer_name} Video Showroom</a>.
            </td>
        </tr>
        </tbody>
    </table>
