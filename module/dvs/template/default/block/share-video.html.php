...
<a href="{if $aDvs.sitemap_parent_url}{$aVideo.parent_video_url}{if Phpfox::isModule('redirect')}share_crm/{else}&share=crm{/if}{else}{$sVideoViewUrl}{$aVideo.shorturl}?utm_source=Share Links&amp;utm_medium=CRM Embed&amp;utm_content={$aVideo.year} {$aVideo.make} {$aVideo.model}&amp;utm_campaign={$aDvs.dealer_name}{/if}"><span style="text-decoration:none;font-weight:bold;">{$aVideo.name}</span></a>
<div style="height:100%;left:0;top:0;width:300px;">
<a href="{if $aDvs.sitemap_parent_url}{$aVideo.parent_video_url}{if Phpfox::isModule('redirect')}share_crm/{else}&share=crm{/if}{else}{$sVideoViewUrl}{$aVideo.shorturl}?utm_source=Share Links&amp;utm_medium=CRM Embed&amp;utm_content={$aVideo.year} {$aVideo.make} {$aVideo.model}&amp;utm_campaign={$aDvs.dealer_name}{/if}">{img server_id=$aVideo.image_server_id path="brightcove.url_image" file=$aVideo.image_path suffix="_email" max_width=300 max_height=300 title=$aVideo.name}</a>
</div>
</div>
'
                </td>
