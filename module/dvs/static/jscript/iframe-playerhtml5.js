if(typeof urlChanged === 'undefined'){
...
//               $(".vjs-overlay").hide();
       ...
       if(bAutoAdvance){
        var endscr_bottom_nvideo = '<h4 class="endscr_bottom_nvideo"><p>Next video starts in <span id="nvideo_timer">5</span>:</p><p id="nvideo_title"></p></h4>';    
        }else{
