if (!window.WTVDVS) {
    window.WTVDVS = {
        render_iframe:function (params) {
            ...
            var sIframe = '<iframe allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" frameborder="0" width="100%" height="1000px" style="width:100%;height:1000px;" src="' + params.iframeUrl + 'parent_' + this.encode_base64(encodeURIComponent(sParentUrl)) + '/maxwidth_' + iMaxWidth + '/"></iframe>';
