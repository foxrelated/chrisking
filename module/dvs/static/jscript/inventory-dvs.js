function menuHome(sSource) {
	sendToGoogle('DVS URL Player', sSource, 'Home');
...
function menuInventory(sSource) {
	sendToGoogle('DVS URL Player', sSource, 'Show Inventory');
...
function menuOffers(sSource) {
	sendToGoogle('DVS URL Player', sSource, 'Special Offers');
...
function menuContact(sSource) {
	sendToGoogle('DVS URL Player', sSource, 'Contact Dealer');
...
function menuEmail(sSource) {
	sendToGoogle('DVS URL Player', sSource, 'Email Menu Link');
...
function menuFooter(sSource) {
	sendToGoogle('DVS URL Player', sSource, 'Footer Link Clicked');
...
function facebookShareClick(sSource) {
	if (aCurrentVideoMetaData) {
		...
		sendToGoogle('DVS URL Player', sSource, 'Facebook Share Clicked', oCustomVars);
...
function googleShareClick(sSource) {
	if (aCurrentVideoMetaData) {
		...
		sendToGoogle('DVS URL Player', sSource, 'Google Share Clicked', oCustomVars);
...
function showEmailShare(iDvsId) {
	if (aCurrentVideoMetaData) {
		...
		sendToGoogle('DVS URL Player', 'Share Links', 'Email Share Clicked', oCustomVars);
...
function shareEmailSent() {
	if (aCurrentVideoMetaData) {
		...
		sendToGoogle('DVS URL Player', 'Share Links', 'Email Share Sent', oCustomVars);
...
function getPriceEmailSent() {
	if (aCurrentVideoMetaData) {
		...
		sendToGoogle('DVS URL Player', 'Dealer Contact', 'Lead Sent', oCustomVars);
...
$Behavior.dvs = function() {
	...
	function clickEventToAnalytics(intentEvent) {
		...
		sendToGoogle('DVS URL Player', 'Share Links', 'Twitter Share Clicked', oCustomVars);
	...
	function tweetIntentToAnalytics(intentEvent) {
		...
		sendToGoogle('DVS URL Player', 'Share Links', 'Tweet Posted', oCustomVars);
