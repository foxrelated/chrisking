...
You can try to log in again in {iUnlockTimeOut} minutes.',
  ...
  'community' => 'Community',
  'complete_this_step_to_setup_your_personal_profile' => 'Please answer the following anti-spam question to complete your registration:',
...
Why not come and pay a visit to your friends, there\'s lots of catching up to do</p>',
  ...
  'join_ssitetitle_to_connect_with_friends_share_photos_and_create_your_own_profile' => 'Join {sSiteTitle} to experience the ultimate video marketing platform.',
  ...
  'menu_user_members_532c28d5412dd75bf975fb951c740a30' => 'Users',
  'menu_user_privacy_settings_73c8da87d666df89aabd61620c81c24c' => 'Privacy Settings',
  'menu_user_settings_4ee1a589029a67e7f1a00990a1786f46' => 'Settings',
  ...
  'password_request_successfully_sent_check_your_email_to_verify_your_request' => 'Password request successfully sent. Please check your email for reset instructions.',
  ...
  'please_reenter_your_email_again_below' => 'Please re-enter your email again',
...
Set it to 0 to disable the timeout.</info>',
  ...
  'ssitename_helps_you_connect_and_share_with_the_people_in_your_life' => '{sSiteName} is the ultimate automotive video marketing platform for dealers.',
  'ssitetitle_helps_you_connect_and_share_with_the_people_in_your_life' => '{sSiteTitle} is the ultimate automotive video marketing platform.',
  'ssitetitle_is_an_invite_only_community_enter_your_email_below_if_you_have_received_an_invitation' => '{sSiteTitle} is invite only. Enter your email below if you received an invitation. If you would like to be invited, please <a href="http://contact.wtvdvs.com">contact us</a>.',
  'staff' => 'Staff',
  'status' => 'Status',
  ...
  'the_link_that_brought_you_here_is_not_valid_it_may_already_have_expired' => '<p>This verification link is valid or may have expired. Email verification links expire {time} after being sent.</p>
<p>Please try again with the new verification email we&#039;ve just sent.</p>',
  ...
  'this_site_is_very_concerned_about_security' => '<h1>Note: Make sure you check your Spam or Junk folder if the email is not in your inbox. The email will be from WheelsTV or noreply@wtvdvs.com (we encourage you to add us to your email whitelist).</h1><br>',
  ...
  'user_sales_associate' => 'Sales Associate',
...
Leave to 0 for unlimited',
  ...
  'your_account_has_been_approved_on_site_title' => 'Your account for {site_title} has been approved. Thanks for your patience!

<a href="{link}">Click here to login</a> or visit <a href="{link}">{link}</a> to get started.

<a href="http://contact.wtvdvs.com">Contact Us</a> if you have any questions.</div>',
  'your_account_has_been_deleted' => 'Your account has been deleted.',
  'your_account_is_pending_approval' => '<br>
<div align="center"><h1>You&#039;re almost done!</h1><br>
<p style="font-size:14px;"><b>Your account is pending approval while we finalize account setup in our billing system.<br><br>You will receive another email once your account has been approved. Stay tuned, and thank you for your patience!</b></p><br><br><a href="http://contact.wtvdvs.com">Contact Us</a> if you have any questions.</div>',
  ...
  'your_email_has_been_verified_please_log_in_with_the_information_you_provided_during_sign_up' => '<b>Your email has been verified!</b><b><br>You&#039;re almost done... You will receive another email once your account has been approved. Stay tuned, and thank you for your patience!',
...
<a href="{link}">{link}</a>',
  ...
  'you_need_to_verify_your_email_address_before_logging_in' => '<p style="font-size:16px;">You need to verify your email address before we can approve your account.</p><br><p style="font-size:16px;">We sent a verification email to <b>{email}</b></p>',
  'you_registered_an_account_on_site_title_before' => 'Please click the link below to verify your email address for {site_title}:
<a href="{link}">{link}</a>

<a href="http://contact.wtvdvs.com">Contact Us</a> if you have any questions.',
  'you_registered_an_account_on_site_title_before_being_able_to_use_your_account_you_need_to_verify_that_this_is_your_email_address_by_clicking_here_a_href_link_link_a' => 'Thank you for signing up for {site_title}. Please click the link below to verify your account:

<a href="{link}">{link}</a>


Email verification is required to confirm you&#039;re a real person, and not a spammer.

After your email has been verified, we will need to review your account for final approval.',
