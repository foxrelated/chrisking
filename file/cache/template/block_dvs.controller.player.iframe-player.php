...
<?php if ($this->_aVars['aPlayer']['preroll_file_id']): ?>
...
<section id="playlist_wrapper<?php if ($this->_aVars['inventoryList']): ?> inventory_wrapper<?php endif; ?>">
<?php if ($this->_aVars['aDvs']['inv_display_status']): ?>
<?php if ($this->_aVars['inventoryList']): ?>
    <div class="inventory_info_message">
<?php if (count($this->_aVars['inventoryList']) > 1): ?>
<?php echo count($this->_aVars['inventoryList']); ?> <?php echo $this->_aVars['aFirstVideo']['model']; ?>’s available in inventory! Select one below:
<?php elseif (count($this->_aVars['inventoryList']) == 1): ?>
<?php echo count($this->_aVars['inventoryList']); ?> <?php echo $this->_aVars['aFirstVideo']['model']; ?> available in inventory! Select one below:
<?php endif; ?>
    </div>
