...
<?php if ($this->_aVars['bc'] != 'refid' && ! $this->_aVars['bPreview']): ?>
            body {
                background-image: url('<?php echo $this->_aVars['sBackgroundPath']; ?>');
                ...
                background-color: #<?php echo $this->_aVars['aDvs']['page_background']; ?>;
            }
<?php endif; ?>

			section h1,h2,h3,h4,h5,h6,h7 {
				color: #<?php echo $this->_aVars['aDvs']['page_text']; ?>;
			}
...
<?php endif; ?>
<?php if (!$this->bIsSample): ?><div id="site_content"><?php if (isset($this->_aVars['bSearchFailed'])): ?><div class="message">Unable to find anything with your search criteria.</div><?php else:  $sController = "dvs.view";  if ( Phpfox::getLib("template")->shouldLoadDelayed("dvs.view") == true ): ?>
