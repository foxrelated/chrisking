...
<?php endif; ?>
	...
	autoUpdate(<?php echo $this->_aVars['iOffset']; ?>);

	<?php echo '
		$(\'#progress_inner\').stop().animate({
			width: \'';  echo $this->_aVars['iPercentage'];  echo '%\'
		}, 300, function() {});
	'; ?>

	$("#progress_percentage").html("<?php echo $this->_aVars['iPercentage']; ?>%");
	$("#progress_stopped").html("<a href=\"#\" onclick=\"restart(<?php echo $this->_aVars['iOffset']; ?>);\">Restart</a>");
	

</script>
<?php echo $this->_aVars['iOffset']; ?> of <?php echo $this->_aVars['iTotal']; ?>. Batch completed in <?php echo $this->_aVars['iTime']; ?> seconds.
