...
<?php if (isset ( $this->_aVars['sMessage'] ) && $this->_aVars['sMessage']): ?>
	<?php echo '
...
<div id="add_dvs_button" <?php if (! $this->_aVars['bCanAddDvss']): ?>style="display:none;"<?php endif; ?>>
	<a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.settings'); ?>" class="button-link" style="width:90px;height:10px;padding:2px 2px 15px 2px;margin:0px;"><?php echo Phpfox::getPhrase('dvs.add_dvs'); ?></a>
	<div class="main_break"></div>
	<div class="main_break"></div>
</div>

<?php if ($this->_aVars['aDvss']): ?>
	<div id="dvss"  style="margin:15px 0px 0px 0px;">
...
<?php if (count((array)$this->_aVars['aDvss'])):  foreach ((array) $this->_aVars['aDvss'] as $this->_aVars['aDvs']): ?>
				<tr id="dvs_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>">
					<td colspan="2" valign="middle" style="text-align:left;vertical-align:middle;font-size:15px;">
						<a href="<?php if ($this->_aVars['bSubdomainMode']):  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aDvs']['title_url']);  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.'.$this->_aVars['aDvs']['title_url']);  endif; ?>" target="_blank"><?php echo $this->_aVars['aDvs']['dealer_name']; ?></a>
					</td>
					...
					<td valign="middle" style="text-align:right;vertical-align:middle;">
						...
						<ul>
						   <li class="has-sub"><a href="#"><span>Settings</span></a>
							  <ul>
								 <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.settings', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>"><span>Edit Settings</span></a></li>
								 <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.customize', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>"><span>Customize Styling</span></a></li>
								 <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.player.add', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>"><span>Player Settings</span></a></li>
								 <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.salesteam', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>"><span>Manage Sales Team</span></a></li>
<?php if (Phpfox ::isAdmin()): ?>
                                 <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.manager', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>"><span>Manage Managers Team</span></a></li>
<?php endif; ?>
							  </ul>
						   </li>
						   <li class="has-sub"><a href="#"><span>Sharing</span></a>
							  <ul>
								 <li><a href="<?php if ($this->_aVars['bSubdomainMode']):  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aDvs']['title_url']);  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.'.$this->_aVars['aDvs']['title_url']);  endif; ?>share"><span>Share Links</span></a></li>
								 <li><a href="<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.reports.share.'.$this->_aVars['aDvs']['title_url']); ?>"><span>Share Report</span></a></li>
							  </ul>
						   </li>
						   <li class="has-sub"><a href="#"><span>Integrate</span></a>
							  <ul>
                                <li><a href="#" onclick="$('#dvs_gallery_link_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>').dialog({width: 500});"><span>DVS Gallery Code</span></a></li>
								<li><a href="#" onclick="$('#dvs_iframe_link_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>').dialog({width: 500});"><span>DVS iFrame Code</span></a></li>
                                <li><a href="#" onclick="$('#vdp_embed_link_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>').dialog({width: 500});"><span>VDP Embed Code</span></a></li>
							  </ul>
						   </li>
<?php if (Phpfox ::isAdmin()): ?>
						   <li class="active"><a href="#" onclick="if (confirm('<?php echo Phpfox::getPhrase('core.are_you_sure', array('phpfox_squote' => true)); ?>')) { $(this).parents('#dvss:first').find('#dvs_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>:first').hide('slow'); $.ajaxCall('dvs.deleteDvs', 'dvs_id=<?php echo $this->_aVars['aDvs']['dvs_id']; ?>');}"><span>Delete</span></a>
						   </li>
<?php endif; ?>
						</ul>
						</div>
				...
				<tr><td colspan="3">&nbsp;</td></tr>
				<div id="dvs_gallery_link_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>" title="DVS Gallery Embed Code" class="dvs_gallery_link_popup" style="display:none;">
					<p>Add this code to a blank page using HTML code method (not iFrame):<p>
						<p><textarea rows="2" cols="71">&lt;iframe src="<?php if ($this->_aVars['bSubdomainMode']):  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aDvs']['title_url']);  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.'.$this->_aVars['aDvs']['title_url']);  endif; ?>gallery" scrolling="no" frameborder="0" width="800" height="600"&gt;&lt;/iframe&gt;</textarea>
					</p>
				</div>
				<div id="dvs_iframe_link_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>" title="DVS iFrame Embed Code" class="dvs_iframe_link_popup" style="display:none;">
					<p>Add this code to a blank page using HTML code method (not iFrame):</p>
						<p><textarea rows="13" cols="71">&lt;div id="dvs_wrapper">&lt;/div&gt;
&lt;script type="text/javascript" src="<?php echo $this->_aVars['sCorePath']; ?>module/dvs/static/jscript/embed.js"&gt;&lt;/script&gt;
&lt;script type="text/javascript"&gt;
    WTVDVS.render_iframe({
        "id" : "dvs_wrapper",
        "width" : 952,
        "height" : 1000,
        "iframeUrl" : "<?php if ($this->_aVars['bSubdomainMode']):  echo Phpfox::getLib('phpfox.url')->makeUrl($this->_aVars['aDvs']['title_url']);  else:  echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.'.$this->_aVars['aDvs']['title_url']);  endif; ?>iframe/"
    });
&lt;/script&gt;</textarea>
					</p>
            ...
            <div id="vdp_embed_link_<?php echo $this->_aVars['aDvs']['dvs_id']; ?>" title="VDP Embed Code" class="dvs_iframe_link_popup" style="display:none;">
                <p>Step 1: Add this code after the &lt;body&gt; tag of the page:</p>
                    <textarea rows="10" cols="71">&lt;script type="text/javascript" src="<?php echo $this->_aVars['sCorePath']; ?>module/dvs/static/jscript/vin.js"&gt;&lt;/script&gt;
&lt;script type="text/javascript"&gt;
WTVVIN.init({
    "dvs" : <?php echo $this->_aVars['aDvs']['dvs_id']; ?>,
    "apiUrl" : "<?php echo Phpfox::getLib('phpfox.url')->makeUrl(''); ?>",
    "styleUrl" : "<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.vin.style', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>",
    "scriptUrl" : "<?php echo Phpfox::getLib('phpfox.url')->makeUrl('dvs.vin.script', array('id' => $this->_aVars['aDvs']['dvs_id'])); ?>",
});
&lt;/script&gt;</textarea>
                </p>
...
<?php endforeach; endif;  if (!isset($this->_aVars['aPager'])): Phpfox::getLib('pager')->set(array('page' => Phpfox::getLib('request')->getInt('page'), 'size' => Phpfox::getLib('search')->getDisplay(), 'count' => Phpfox::getLib('search')->getCount())); endif;  $this->getLayout('pager'); ?>
		</table>
	</div>
<?php endif; ?>
